...
<head>
    ...
    <script type="text/JavaScript" src="{{asset('assets/js/storeUser.js')}}"></script>
            ...
            <div class="container templatemo_container">
                <div class="row">
                    <div class="col-sm-3 col-md-3">
                        <div class="logo">
                            <a href="/users"><img src="{{asset('assets/images/templatemo_logo.png')}}"
                    ...
                    <div class="col-sm-9 col-md-9 templatemo_col9">
                        <div id="top-menu">
                            <nav class="mainMenu">
                                <ul class="nav">
                                    <li><a class="menu" id="menu-id" href="/users/create">Users registration</a></li>
                                </ul>
                                <ul class="nav">
                                    <li><a class="menu" id="menu-id" href="/users">Users</a></li>
                                </ul>
                                <ul class="nav">
                                    <li><a class="menu" id="menu-id" href="/token">Get token</a></li>
                                </ul>
                                <ul class="nav">
                                    <li><a class="menu" id="menu-id" href="/positions">Positions</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="container" style="margin-top: 10px">
            <div class="row">
                <div class="container list">
                    ...
                    <form id="form-register" method="POST" action="api/users/" enctype="multipart/form-data">
                        <div class="row">
